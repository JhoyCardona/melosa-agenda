...
// One-off: ADD $30.000 minicake designs, without touching anything already in
// the catalog. Same shape as addCatalogDesigns29000 (that tier was renamed —
// gretica settled on $30.000, not $29.000 — this is its successor script, same
// solo_imagen / texto_e_imagen split):
//
//   30000/solo_imagen/<designNumber>/<colorName>.jpg
...
//   30000/texto_e_imagen/<designNumber>/<colorName>.jpg
...
//
//   npx ts-node src/scripts/addCatalogDesigns30000.ts --yes solo_imagen:1,2 texto_e_imagen:1,3,4,5

const SOURCE_ROOT =
  process.env.CATALOG_SOURCE_ROOT ??
  '/home/jhoyners-cardona/proyects/melosa/imagenes-promo-minicakes/30000';

const VARIANT_TEMPLATE = [
  { label: 'Minicake (2 porciones)', price: 30000, points: 4, prepMinutes: 20, portions: null, enPromocion: true },
  { label: '6 porciones', price: 75000, points: 6, prepMinutes: 20, portions: 6, enPromocion: false },
  { label: '10 porciones', price: 130000, points: 8, prepMinutes: 20, portions: 10, enPromocion: false },
  { label: '15 porciones', price: 180000, points: 10, prepMinutes: 20, portions: 15, enPromocion: false },
  { label: '20 porciones', price: 230000, points: 12, prepMinutes: 20, portions: 20, enPromocion: false },
];
...
main()
  .catch((error) => {
    console.error('addCatalogDesigns30000 failed:', error);
    process.exitCode = 1;
  })
  .finally(async () => {
